        ...
        if purchase_df.shape[0] > 0:
            ...
            if request.method == 'POST':
                ...
                if chart_type != "":
                    ...
                    error_message = 'Selecione um tipo de grafico'

        else:
            error_message = 'Nenhum banco de dados foi encontrado'
    except:
        product_df = None
        purchase_df = None
        error_message = 'Base de dados vazio'
...
def add_purchase_view(request):
    ...
    if form.is_valid():
        ...
        form = PurchaseForm()
        added_message = "Compra efetuada com sucesso!!"
